...
CUDA_VISIBLE_DEVICES=1 python scripts/train_dreamer.py --configs=dmc_vision videogpt_prior_rb --task=dmc_cartpole_swingup --reward_model=dmc_clen16_fskip4_cartpole_swingup --logdir=./logs/dmc_cartpole_swingup/debug_mine_large
