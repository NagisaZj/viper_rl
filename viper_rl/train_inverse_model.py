...
if __name__=='__main__':
    ...
    directory = '/data/zj/viper_rl/viper_rl_data/mydata/quadruped_run'
    ...
    for i in range(10000):
        ...
        if i % 1000==0:
            print(i,loss, loss2)
            torch.save(trainer.inverse_model.state_dict(),'/data/zj/viper_rl/viper_rl_data/checkpoints/inverse_model/quadruped_run/inverse_debug.pth')
            torch.save(trainer.prediction_model.state_dict(),'/data/zj/viper_rl/viper_rl_data/checkpoints/inverse_model/quadruped_run/prediction_debug.pth')