...
class MyJAXAgent(embodied.MyAgent):
    def __init__(self, agent_cls, obs_space, act_space, step, config,reward_model):
        ...
        self._setup()
        self.agent = agent_cls(obs_space, act_space, step, config,reward_model=reward_model, name="agent")
